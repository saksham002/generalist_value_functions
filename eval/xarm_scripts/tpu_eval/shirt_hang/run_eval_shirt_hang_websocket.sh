...
LOG_VIDEOS=true
VIDEO_SUBDIR="real_shirt_hang_paligemma_cql_rlds_finetune_subtask_ar_final, 250k N=8"   # optional subdir under eval/xarm_scripts/tpu_eval/shirt_hang/videos/ (empty = save directly there)
DEBUG_VALUES=false
MANUAL=true
# =============================================================================
