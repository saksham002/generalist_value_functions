#!/bin/bash
# Sim bimanual assembly policy server launcher. Delegates to scripts/run_on_tpu.py.
...
CRITIC_DIR="gs://saksham-euw4/checkpoints/robocoin/value_functions/Q/robocoin_bimanual_paligemma_q_sarsa_chunk_wise_delta/robocoin_bimanual_paligemma_q_sarsa_chunk_wise_delta/sim_bimanual_assembly_paligemma_q_sarsa_finetune_chunk_wise_delta"
CRITIC_STEP=238000
CRITIC_FT_CONFIG="sim_bimanual_assembly_paligemma_q_sarsa_finetune_chunk_wise_delta"
NUM_SAMPLES=8
# =============================================================================
...
echo "================================================"
echo "Sim bimanual assembly policy server (via run_on_tpu.py)"
echo "================================================"
