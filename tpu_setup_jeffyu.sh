...
mkdir -p /data/user_data/jeffyu/uv/{bin,cache}
curl -LsSf https://astral.sh/uv/install.sh | \
  UV_INSTALL_DIR=/data/user_data/jeffyu/uv/bin \
  sh

echo '
# ---------- uv ----------
export UV_ROOT="/data/user_data/jeffyu/uv"
...
export NASM_PREFIX=/data/user_data/jeffyu/nasm
...
export PKGCONFIG_PREFIX=/data/user_data/jeffyu/pkg-config
...
export FFMPEG_PREFIX=/data/user_data/jeffyu/ffmpeg-7
...
cd /data/user_data/jeffyu/batch_value_learning
