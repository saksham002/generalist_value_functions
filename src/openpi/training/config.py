...
_CONFIGS = [
    ...
    *polaris_config.get_polaris_configs(),
    ...
    # RoboCOIN MC value function with HL-Gauss head frozen to grouped-sum logits.
    TrainConfig(
        name="robocoin_paligemma_v_mc_hl_gauss_freeze_head",
        model=_value_function.MCValueFunctionConfig(
            network_config=_paligemma_network.PaliGemmaNetworkConfig(
                state_dim=14,  # Proprioceptive state dimension for RoboCOIN
                num_cameras=3,
    ...
    TrainConfig(
        ...
        data=RoboCOINDataConfig(
            ...
            dataset_name="robocoin:1.0.0",
            discount=0.99,
            td_n=15,  # TD-30: bootstrap with value at t + 30
            use_eef=True,
        ),
        weight_loader=weight_loaders.PaliGemmaWeightLoader(),
        num_train_steps=30_000,
