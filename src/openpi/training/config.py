...
_CONFIGS = [
    ...
    *polaris_config.get_polaris_configs(),
    ...
    # Pi-0.5 on the real_lid dataset. Clone of real_shirt_hang_pi05 with the data
    # paths pointed at the us-central2 lid dataset (bf16, batch 256, frequent saves).
    TrainConfig(
        name = "real_lid_pi05",
        model = pi0_config.Pi0Config(
            paligemma_variant = "gemma_2b",
        ...
        data = Hdf5RldsDataConfig(
            ...
            assets = AssetsConfig(
                assets_dir = "gs://saksham-usc2/datasets/real_lid",
                asset_id = "norm_stats",
            ),
            discount = 0.999,
            td_n = 60,
