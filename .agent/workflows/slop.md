...
3. Review each file and remove the following types of AI slop:
   ...
   - **Defensive over-engineering**: Extra defensive checks, try/catch blocks, or error handling that is abnormal for that area of the codebase (especially if called by trusted/validated codepaths)
